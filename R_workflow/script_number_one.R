...
datos <- read.csv(file="/Users/aldotapia/Desktop/Proyectos/Landsat_sequia/Datos_cr2/cr2_prAmon_2017/cr2_prAmon_2017.txt",
                  header = T,skip = 14,sep = ",",na.strings = -9999)

# Read stations metadata
estaciones <- read.csv(file="/Users/aldotapia/Desktop/Proyectos/Landsat_sequia/Datos_cr2/cr2_prAmon_2017/cr2_prAmon_2017_stations.txt")
